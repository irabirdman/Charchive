        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-300">
          ...
          {world.races_species ? (
            ...
            <div>
              ...
              <p className="text-gray-400 italic">Consectetur adipiscing elit</p>
            </div>
          )}
          {world.culture ? (
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400 italic">Sed do eiusmod tempor</p>
            </div>
          )}
          {world.government ? (
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400 italic">Incididunt ut labore</p>
            </div>
          )}
        </div>
      </div>
